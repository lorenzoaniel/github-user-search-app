...
const DarkModeToggleButton: React.FC = () => {
	...
	const toggleImgSrc = isDarkMode ? (
		<svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
			<g fill="#FFF" fill-rule="nonzero">
				<path
					className="toggle-icon
				group-hover:fill-hover-darkmode
				group-hover:dark:fill-dark-hover-darkmode
					"
	...
	return (
		...
		>
			<span
				...
				text-themetoggle
				tracking-[0.25rem]
				group-hover:text-hover-darkmode
				group-hover:dark:text-dark-hover-darkmode
				"
			>
